...
def change_phone(address_book,*arg):
    ...
    if name == "":
        ...
        return None
    print(contact)
    phone = input_data("Введіть номер телефону який необхідно замінити (xxxxxxxxxx) (Вийти 'no') \n")
    if phone == 'no':
        return None
    elif Phone(phone).value:
        phone_new = input_data("Введіть новий номер телефону (xxxxxxxxxx) (Вийти 'no') \n")
        if phone_new == 'no':
            return None
...
def change_email(address_book,*arg):
    ...
    if name == "":
        ...
        return None
    print(contact)
    email = input_data("Введіть e-mail який необхідно замінити (Вийти 'no') \n")
    if email == 'no':
        return None
    elif Email(email).value:
        email_new = input_data("Введіть новий номер телефону (xxxxxxxxxx) (Вийти 'no') \n")
        if email_new == 'no':
            return None
